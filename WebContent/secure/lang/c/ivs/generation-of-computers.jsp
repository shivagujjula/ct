...
<script src="/secure/lang/c/js-min/goc.min.js" type="text/javascript"></script> 
...
<div class="margin-top-2">
	<div class="col-xs-8 col-xs-offset-2 margin-top-20" id="informationDiv" style= "border: 1px solid gray;" >
