...
<div class="col-xs-12 text-center">
	<div class="margin-padding-css text-center" >
		...
		<div class="col-xs-offset-3 col-xs-3">
			<h3><span class="ct-demo-heading label label-default" id="titleName">Usage of #undef</span></h3>
		</div>
	</div>
</div>
...
<span id="totalBackground"><span id="line2">#define BACKGROUND 8</span>
<span id="totalForeground"><span id="line3">#define FOREGROUND 7</span>
<span id="line4">main()</span> {
