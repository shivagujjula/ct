...
<div class = "col-xs-12">
	<div class = "ct-box-main">
		 <div class = "text-center">
			<h1 class = "label ct-demo-heading text-center">Pre increment operator</h1>
		</div> 
			...
			<div id = "animationDiv"  class = "col-xs-5 box-border margin-top padding0">
				<div class = 'col-xs-12 padding0'>
					<div class = 'col-xs-8 col-xs-offset-2 padding0' id = "animationDiv1">
						<div class = 'col-xs-12 text-center animation-div1 padding0'>
							<span id = 'yVariableLine' class = "box-padding ">int y = <span class = "box-padding" id = "preincrement"><span id="ct-code-b-blue">++</span>x</span></span>
							<svg class = 'svg-css'>
								<marker id = "arrowEnd" refX = "4" refY = "2.5" markerWidth = "5" markerHeight = "5" orient = "auto" style = "fill: gray;">
									<path d = "M0,0 L5,2.5 L0,5 Z"/>
								</marker>
								<text fill = "#333">
									<tspan x = "41%" y = "17%" fill = "white" class = 'svg-text'>pre-increment</tspan>
								</text>
								<line class = "svg-line" x1 = "62%" y1 = "51.3%" x2 = "62%" y2 = "39.2%" style = "marker-end: url(&quot;#arrowEnd&quot;); display: none;
				...
				<div class="col-xs-12 padding0">
					<div class="col-xs-3 col-xs-offset-2 text-center visibility-hidden padding0" id="xCup">
	  					<i class="fa fa-coffee fa-3x fa-blue x-cup"></i><span id="xCupValue" class="cupvalue visibility-hidden">8</span><br>
					...
					<div class="col-xs-3 col-xs-offset-1 text-center visibility-hidden padding0" id="yCup">
	  					<i class="fa fa-coffee fa-3x fa-blue y-cup"></i><span id="yCupValue" class="cupvalue visibility-hidden">8</span><br>
