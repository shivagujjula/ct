...
function introGuide() {
	...
	introguide.onbeforechange(function(targetElement) {
		...
		if (elementId == "inputDiv") {
			...
			typingContent = '<span id="inputText">Enter a decimal value and click the <span class="btn btn-success btn-xs" style="cursor: default;">Convert to Octal</span> button to see how the Decimal to Octal' + "" 
