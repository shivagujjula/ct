...
var pyramidLowerTriangleNumberReady = function() {
...
function innerLoopOne () {
	...
	var text="This inner <b class='ct-code-b-yellow'>for-loop</b> is used to print number of <b class='ct-code-b-yellow'>*</b>  on each line.(Yellow color)";
...
function printAnimation(count,callBackFunction) {
	...
	if (count <= iCount) {
		arrow("#jForLoop","#printNumber",function() {
			$(".print.space").removeClass("blinking").html("&nbsp;");
			$(".print").last().removeClass("blinking");
			$("#row" + iCount).append("<span class='print'>"+count+"</span>");
