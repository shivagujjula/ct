...
function introJsGuide() {
	...
	introjs.setOptions({
		steps : [ {
			...
			intro : "Above example demonstrates the working of <b class='ct-code-b-yellow'>continue</b> " 
					+ "statements.",
			position : "bottom"
		}, {
			element : "#initialization",
			intro : "The local variable <b class='ct-code-b-yellow'>i</b> is declared and initialized to value " 
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "continueStmt":
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				var newStep = {
						element : "#update",
						intro : "Now the control is transferred to <b class='ct-code-b-yellow'>update</b> section." 
