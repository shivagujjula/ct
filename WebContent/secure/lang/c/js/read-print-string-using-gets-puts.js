var readPrintStringUsingGetsPutsReady = function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		case "line2" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "<ul><li>Here, ch is the <span class='ct-code-b-yellow'>character array varaiable</span> which contains 20 characters.</li><li>Each element occupies <span class='ct-code-b-yellow'>1</span> byte(8 bits) in the memory.</li></ul> ", 0.05, "",function() {
			...
			if(intro._currentStep == 2) {
				$('.introjs-helperLayer ').one('transitionend', function() {
					...
					TweenMax.to("#tableId", 0.2, {opacity: 1, onComplete: function() {
						typing(".introjs-tooltiptext", "20 bytes are allocated to the array of the variable <span class='ct-code-b-yellow'>ch</span>.", 0.05, "",function() {
							$('.introjs-nextbutton').show();
						});
					}});
				});
		...
		case "line4" :
			...
			$('.introjs-nextbutton').hide();
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "<ul><li><span class='ct-code-b-yellow'>gets()</span> is library function it reads a string from the keyboard. </li><li><span class='ct-code-b-yellow'>gets()</span> function reads <span class='ct-code-b-yellow'>whitespace</span> characters.</li></ul>", 0.05, "",function() {
		...
		case "line6" :
			$('.introjs-nextbutton').hide();
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "<span class='ct-code-b-yellow'>puts()</span> is library function.<br/> It displays a string onto the output screen.", 0.05, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
			...
			if(intro._currentStep == 4) {
				$('.introjs-helperLayer ').one('transitionend', function() {
					...
					typing("#typeChar", "<span id='totalBlinkText'>Enter a String : <span id='blinkChar'><input id='in' maxlength='0' tabindex='0' value=''/></span></span>", 0.05, "",function() {
						...
						$("#totalBlinkText").addClass("hidden");
						$("#inputChar").focus();
						typing(".introjs-tooltiptext", "Enter a string. ", 0.05, "",function() {
				...
				$('.introjs-helperLayer ').one('transitionend', function() {
					typing("#totalEnterChar", "The entered string is : <span id='putValueId'></span>", 0.05, "",function() {
	...
	typing(".introjs-tooltiptext", "Let us see a sample program on the usage of the functions <span class='ct-code-b-yellow'>gets()</span> and <span class='ct-code-b-yellow'>puts()</span>.", 0.05, "",function() {
		$('.introjs-nextbutton').show();
	});
}
