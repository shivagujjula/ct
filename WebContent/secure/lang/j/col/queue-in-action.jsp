...
<script type="text/javascript">
	...
	<div class="margin-top" id="executionDiv">
			<div class="col-xs-4 box-border methods-div method-code margin-left">
				...
				<ul id="methodsGroup" class="list-group">
				  <li id = "method1" class="list-group-item  methods-div-list">aDeque.<span class="methods-color">offer("<span contenteditable="true" id="offerMethod" class="entered-element ct-pink-color" placeholder="element" maxlength="8" spellcheck="false"></span>");</span><button type="button" class="btn btn-success  btn-sm go-button disabled" id="offerBtn">Go</button></li>
				  <li id = "method2" class="method2 list-group-item  methods-div-list">aDeque.<span class="methods-color">poll();</span><button type="button" class="btn btn-success  btn-sm go-button disabled" id="pollBtn">Go</button></li>
				  <li id = "method3" class="method3 list-group-item  methods-div-list">aDeque.<span class="methods-color">peek();</span><button type="button" class="btn btn-success  btn-sm go-button disabled" id="peekBtn">Go</button></li>
				</ul>
	...
	public static void main(String[] args) {
		  ...
		  <span id="randomCode"><span id="statusDeclaration" class="visibility-hidden">boolean offerStatus = aDeque.offer("<span id="editElement0" class="edit-element ct-pink-color" contenteditable="true" maxlength="8" spellcheck="false">Brazil</span>");</span>
		  <span id="offerStatusId1" class="visibility-hidden">System.out.println("offerStatus for <span id="sopElement0">Brazil</span>: " + offerStatus);</span>
		  <span id="methodCall2" class="visibility-hidden">offerStatus = aDeque.offer("<span id="editElement1" class="edit-element ct-pink-color" contenteditable="true" maxlength="8" spellcheck="false">Greece</span>");</span>
		  <span id="offerStatusId2" class="visibility-hidden">System.out.println("offerStatus for <span id="sopElement1">Greece</span>: " + offerStatus);</span></span>
	}
}						
					</pre>
				</div>
			...
			<div class="box-border" id="animationDiv">
				<div id="exitDiv" class='col-xs-1 padding-col0 text-center'></div>
					<div id="jar" class = "jar-div col-xs-offset-1 col-xs-7">
						<div id="queueTitle">
							<div><div id="head">Head</div><div id="end">Tail</div>Queue </div>
	             		</div>
	             			
						<div id="queueDiv1" class = "queue-div-1"></div>
						<div class = "elements-div">
							<span id='textBox0' class ='elements visibility-hidden click-check'></span>
							<span id='textBox1' class ='elements visibility-hidden click-check'></span>
						</div>
