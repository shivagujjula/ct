...
<script src="../js/simple-java-program-with-println.js"></script>
...
<span id="line7">}</span>
		...
		<div class="col-xs-5">
			...
			<div class="output-console-body" id="body">
				<div class="opacity00 green" id="printlnId1"> <b>Hello</b></div>
				<div class="opacity00 green" id="printlnId2"> <b>I am learning Java.</b></div>
				<div class="opacity00 green" id="printlnId3"> <b>Bye!</b></div>
			</div>
		</div>
	</div>
