...
function introJsGuide() {
	...
	introjs.setOptions({
		steps : [ {
			element : "#brkLoop",
			intro : "The above example demonstrate the working of <b class='ct-code-b-yellow'>break</b> " 
					+ "statements.",
			position : "bottom"
		}, {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "breakStmt":
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				var text = "The <b class='ct-code-b-yellow'>break;</b> statement terminates the " 
