...
var value;
	...
	function introJsGuide() {
		...
		introjs.setOptions({
			steps : [ {
				element : "#switchBlock",
				intro : "The above code demonstrates the working of a <b class='ct-code-b-yellow'>switch</b> construct.",
				position : "bottom"
			}, {
				...
				element : "#openBrace",
				intro : "The code inside this block is called the <b class='ct-code-b-yellow'>switch body</b>.",
				position : "right"
			}, {
				element : "#case1Blk",
				...
				element : "#case2Blk",
				intro : "Control will enter into this block, if <b class='ct-code-b-yellow'>value</b> is equal to <b class='ct-code-b-yellow'>2</b>.",
				position : "bottom",
				tooltipClass : 'introjs-tooltip-custom-width'
			}, {
				element : "#case3Blk",
				intro : "This is an example of a <b class='ct-code-b-yellow'>case</b> where there is no <b class='ct-code-b-yellow'>break;</b> statement."
						+ "<br/><br/>When control enters into such a <b class='ct-code-b-yellow'>case</b> block, after executing that block"
						+ " the control enters into the <b class='ct-code-b-yellow'>case</b> block which follows it.",
				position : "bottom",
				tooltipClass : 'introjs-tooltip-custom-width'
			}, {
				element : "#case34Blk",
				...
				element : "#case56Blk",
				intro : "This is yet another way of clubbing two or more <b class='ct-code-b-yellow'>case</b> blocks.",
				position : "bottom",
				tooltipClass : 'introjs-tooltip-custom-width'
			}, {
				element : "#defaultBlk",
				...
				element : "#initialization",
				intro : "The <b class='ct-code-b-yellow'>int</b> variable <b class='ct-code-b-yellow'>value</b> is declared and initialized to " 
						+ "<b class='changeVal ct-code-b-yellow'>2</b>. You can also change it to any other value." 
						+ "<br><span class='errorText'></span>",
				position : "bottom",
				tooltipClass : 'introjs-tooltip-custom-width'
			}]
					...
					if (introjs._currentStep >= 10) {
						...
						if (caseNumber == "default") {
							var text = "Since the value <b class='ct-code-b-yellow'>" + $("#initializationValue").text() + "</b> does not match any <b class='ct-code-b-yellow'>case</b> constant " 
										+ "the enters the <b class='ct-code-b-yellow'>default</b> block and executes the statements " 
										+ "under it."
...
var switchReady = function() {
	...
	$('.initializeBtn').click(function() {
		value = $('#initializationValue').text();
