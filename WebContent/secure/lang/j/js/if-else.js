...
var dynamicAge;
	...
	function flipEffect() {
		$(".introjs-nextbutton, .introjs-prevbutton").hide();
		$(".animateBtn").remove();
		$('#conditionTest').html("<b><span id='marks' style='display: inline-block;'>age</span> &gt; <span id='disMarks' style='display: inline-block;'>SENIOR_CITIZEN_AGE</span></b>");
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "citizenAge":
			$('.introjs-helperLayer').one('transitionend', function () {
				var text = "An <b class='ct-code-b-yellow'>int</b> variable <b class='ct-code-b-yellow'>SENIOR_CITIZEN_AGE</b> is declared and initialized to " 
		...
		case "initialization":
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				dynamicAge = $('#initializationValue').val();
				var text = "An <b class='ct-code-b-yellow'>int</b> variable <b class='ct-code-b-yellow'>age</b> is declared and initialized to " 
				+ "<b class='ct-code-b-yellow changeVal'>"+ dynamicAge +"</b>.<br/> You can also change the value " 
		...
		case "ifStmt":
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				$('#output').empty().append("<div class='opacity00'>Person is a senior citizen.</div>");
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
				});
		...
		case "elseStmt":
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				$('#output').empty().append("<div class='opacity00'>Person is not a senior citizen.</div>");
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
				});
			});
		...
		case "mainEnd":
			$('.introjs-helperLayer').one('transitionend', function () {
				var text = "This is the end of <span class='ct-code-b-yellow'>main()</span>";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
				});
				/*setTimeout(function() {  //Modification
					introjs.nextStep();
				}, 1000);*/
			});
			break;
