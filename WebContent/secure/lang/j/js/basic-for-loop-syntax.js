	...
	function introJsGuide() {
		...
		introjs.setOptions({
			steps : [{
				...
				intro : "<span>This is the <b>initialization</b> section. Here a local variable <b class='codeText'>i</b> is declared and initialized to <b class='codeText'>0</b>. You can also change the value <b class='codeText'>0</b> to any other number.</span><span id='initialization_Text'></span>",
				position : 'bottom',
			}, {
				element : '.condition',
				intro : "<span>This is the <b>condition</b> part. If the condition evaluates to <b style='color: yellow;'>true</b>, the control enters into the for-loop body.</span><br><span id='condition_Text'></span><br><span id='conditionTyping'></span>",
				position : 'bottom'
			}, {
				element : '.body-Of-The-Loop',
				intro : '<span>The above statement prints the value of <b class="codeText">i</b>.</span>',
				position : 'bottom'
			}, {
				element : '.outputDiv',
				intro : "output",
