...
<script src="../js-min/twnda.min.js"></script>
...
<button type='button' class='btn btn-success btn-execute hidden' id='executeButton'  data-trigger='manual'
		 data-toggle='tooltip' title='Click to Execute' data-placement='bottom'>Execute</button>
			</div>
...
$(document).ready(function() {
	threadsWaitNotifyDemoAutomaticReady();
});
