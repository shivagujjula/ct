...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link rel="stylesheet" href="/css/font-awesome.min.css">
	 	...
	 	<script src="/secure/lang/j/js-min/em.min.js"></script> 
...
%>
	<h3 class="headings" ><span class="label label-default ct-demo-heading">Equals Method in Action</span></h3>
<%
	} if ("2".equals(demoType)) {
%>
	<h3 class="headings" ><span class="label label-default ct-demo-heading">EqualsIgnoreCase Method in Action</span></h3>
<%
	}
%>
