...
<div class="col-xs-12">
	<div class="text-center margin-top-1">
		<h3 class='label ct-demo-heading' id="heading">
			<span>Time Complexity of sum( ) using recursion</span>
		</h3>
	</div>
			...
			<table align="center">
				<tbody>
					...
					<tr>
						...
						<th><span class="opacity00" id="unitsForLessThanOne">n <= 0</span></th>
						<th><span class="opacity00" id="unitsForGreaterThanOne">n > 0</span></th>
					</tr>
					<tr>
...
$(document).ready(function() {
	sumRecursionTimeComplexityFunction();	
});
