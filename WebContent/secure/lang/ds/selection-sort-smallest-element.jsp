...
<script src="/secure/lang/ds/js-min/ssse.min.js"></script>

<title>Selection sort smallest</title>
<style type="text/css">
...
.inner-loop-color, .outer-loop-color, .browen-color, .position-color {
	font-weight: bold;
...
.ct-code-b-red, .ct-code-b-green, .ct-code-b-white, .ct-code-b-blue  {
	font-weight: bold;
	font-family: monospace;
	color: rgb(252, 66, 66);
}
...
int main() {
	...
	<span id="bubbleSortLogic">for (<span class="outer-loop-color">outer</span>Idx = 0; <span class="outer-loop-color">outer</span>Idx < len - 1; <span class="outer-loop-color">outer</span>Idx++) {
		...
		for (<span class="inner-loop-color">inner</span>Idx = <span class="outer-loop-color">outer</span>Idx + 1; <span class="inner-loop-color">inner</span>Idx < len; <span class="inner-loop-color">inner</span>Idx++) {
...
<span id="bubbleSortLogic">	<span id="outerForLoop">for(<span id="outerInti"><span class="outer-loop-color">outer</span>Idx = 0</span>; <span id="outerLoop"><span class="outer-loop-color">outer</span>Idx < len - 1</span>; <span id="outerInc"><span class="outer-loop-color">outer</span>Idx++</span>) {</span>
		...
		<span id="innerForLoop">for(<span id="innerInti"><span class="inner-loop-color">inner</span>Idx = <span class="outer-loop-color">outer</span>Idx + 1</span>; <span id="innerLoop"><span class="inner-loop-color">inner</span>Idx < len</span>; <span id="innerInc"><span class="inner-loop-color">inner</span>Idx++</span>) {</span>
