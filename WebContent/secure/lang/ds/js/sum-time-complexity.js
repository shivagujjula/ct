...
function codeLinesReveledFunction(i) {
	...
	$("#codeLine" + i).fadeTo(500, 1, function() {
		if (i < 7) {
			...
			var text = "This is the iterative code to find the sum of <span class='ct-code-b-yellow'>n</span> natural numbers.<b/>" + 
...
function thirdStepAnimationSecondStep() {
	$("#popover3Text1").after("<span><ul><li id='initLine'><span class='for-loop-li-css'>i = 1</span><br/>In the "+
