 var mergeSortTimeComplexity = function() {
	introGuide();
}
	...
	introjs.onafterchange(function(targetElement) {
				...
				$("#listLine2").fadeTo(500, 1, function() {
					$("#listLine3").fadeTo(500, 1, function() {
						$("#listLine4").fadeTo(500, 1, function() {
							$("#listLine5").fadeTo(500, 1, function() {
								$("#listLine5").after('<span class="introjs-button user-btn">Next &#8594;</span>');
								introjs.refresh();
		...
		case 'preCode1':
			$('.introjs-helperLayer').one('transitionend', function() {
				TweenMax.to($("#preCode1"), 1, {opacity: 1, onComplete: function() {
					var text = 'This is an iterative code for <span class="ct-code-b-yellow">merge sort</span>.';
		...
		case 'preCode2':
			...
			TweenMax.to($("#preCode2"), 1, {opacity: 1, onComplete: function() {
				var text = '<span id="tooltiptextId">This is a recursive code for <span class="ct-code-b-yellow">merge sort.</span>';
					typing('.introjs-tooltiptext', text, function() {
