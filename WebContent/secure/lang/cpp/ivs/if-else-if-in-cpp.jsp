...
<span class='color-green'>#include &lt;iostream&gt;</span>
using namespace std;
<span id='mainFunctions'>int main()</span> {
   <span id='charCh'><span class='color-rose'>char</span> ch;</span>
   <span id='enterCharSpan'><span class='color-maroon'>cout</span> << <span
					class='color-lightblue'>"Enter a character: "</span>;</span>
   <span id='getCh'>ch = <span class='color-lightred'>cin >> ch</span></span>;
<span id='ifElseStatement'>   <span id='ifCondition'><span
      ...
      <span id='ifConditionForLowerCase'><span class='color-rose'>if</span> (<span
         ...
         <span id='printF1'><span class='color-maroon'>cout</span> << ch << <span
						class='color-lightblue'>" is a letter and vowel\n"</span>;</span>
						...
						class='color-rose'>else if</span> (<span id='upperLetterVowels'>ch == <span
							...
							class='color-lightblue'>'O'</span> <span class='color-lightred'>||</span> ch == <span
							class='color-lightblue'>'U'</span></span>)</span> {
         <span id='printF2'><span class='color-maroon'>cout</span> << ch << <span
						class='color-lightblue'>" is a letter and vowel\n"</span>;</span>
      }<span class='color-rose'> else </span>{
         <span id='printF3'><span class='color-maroon'>cout</span> << ch << <span
						class='color-lightblue'>" is a letter and consonant\n"</span>;</span>
      }
   } <span class='color-rose'>else</span> {
