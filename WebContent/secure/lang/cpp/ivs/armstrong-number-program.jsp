					...
					<br><div id="algorithmDiv"  class="col-xs-12 margin-top opacity00">
						...
						<div class="col-xs-12 opacity00" id="whileLoop1">
							...
							<span id="ifConditionDiv">if (sum == copy_of_numbers) {</span><br>
								&emsp;&emsp;<span id="trueStatement">cout << copy_of_numbers << " is an Armstrong number";</span><br>
							} else {<br>
								&emsp;&emsp;<span id="falseStatement">cout << copy_of_numbers << " is not an Armstrong number";</span><br/>
							}
						</div>
					</div>
				</div>
