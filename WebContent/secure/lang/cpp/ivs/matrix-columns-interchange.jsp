...
int main() {
	...
	<span id="printf2">cout << "Enter the numbers of two columns to be exchanged\n";</span>
	<span id="scanf2">cin >> col1 >> col2;</span>
	...
	<span id="printf3">cout << "The matix after interchanging the two columns in the original matrix\n";</span>
