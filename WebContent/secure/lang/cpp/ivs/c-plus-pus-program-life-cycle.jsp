...
<script src="/secure/lang/cpp/js-min/cppplc.min.js"></script>
<style>
...
<pre><span id="preTab" class="opacity00">#include&lt;iostream&gt;
<b style="color: red;">using</b> <b style="color: green;">namespace</b> std;
<b style="color: fuchsia;">int</b> main() {
	cout << "<b style='color: green;'>Hello world!</b>";
}</span></pre>
									</div>
								</div>
							</div>
									...
									<div class="col-xs-12 padding0">
										<div class="col-xs-6 col-xs-offset-3 text-center padding0" id="saveFile">
											...
											<div class="ct-blue-color">
												<span id="fileBelowText" class="opacity00">Hello.cpp</span>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-xs-1 col-xs-offset-2" style="margin-top: 57px;">
							<span id="span1"></span>
						</div>
					</div>
