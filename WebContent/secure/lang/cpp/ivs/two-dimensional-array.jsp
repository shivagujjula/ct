...
int main() {
	...
	<span id='getRowColumn'>cout << "Enter the number of rows and columns : ";</span>
	<span id='scanf'>cin >> rows >> cols;</span>
	<span id='getInputValues'>for (i = 0; i &lt; rows; i++ ) {
		for (j = 0; j &lt; cols; j++ ) {
			<span id='matrixValues'>cout << "Enter the value of a[" << i << "][" << j <<"] : ";</span>
			cin >> a[i][j];
		}
	} </span>
