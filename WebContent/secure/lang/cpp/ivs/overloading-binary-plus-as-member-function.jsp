...
<script src='/secure/lang/cpp/js-min/obpamf.min.js'></script>
<title>Overloading binary plus as member function</title>
</head>
<style>
...
<script>
	$(document).ready(function() {
		overloadingBinaryPlusAsMemberFunctionReady();
	});
</script>
<body>
<div class="main-div col-xs-12">
	<div class="row text-center" id="heading">
		<h3 class='label ct-demo-heading margin-top-2'>
			<span>Overloading  binary <span class='ct-code-b-yellow'>+</span> as member function</span>
		</h3>
	</div>
...
<span id="class" class="opacity00">class Sample {
	...
	<span id="public" class="opacity00">public:</span> 
		...
		<span id="memberFunction" class="opacity00">Sample operator +(Sample s2) {
