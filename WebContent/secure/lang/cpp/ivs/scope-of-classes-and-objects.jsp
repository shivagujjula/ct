...
<body>
	<div class ="text-center margin-top-20">
		<h4 class="label ct-demo-heading" id="demoTitle">Scope of Classes and Objects</h4>
	</div>
	<div class = "margin-top-20">
		<div class = "col-xs-8 col-xs-offset-2 margin-top-20 introjs-showElement opacity00"
...
<span id="object1"><b class='ct-blue-color'>Outer</b> <b class='ct-red-color'>out</b></span>;
<span id="func2">void display() {
	 <span id="objVal2"><b class='ct-red-color'>out</b>.id = <span id="value2">502</span>;</span>
  	 <span id="cout2">cout << <b class='ct-red-color'>out</b>.id << endl;</span>	 
}</span>
<span id="main">int main() {
    <span id="objVal1"><b class='ct-red-color'>out</b>.id = <span id="value1">501</span>;</span>
...
<span id="main1">int main() {
    ...
    <span id="object2"><b class='ct-blue-color'>Inner</b> <b class='ct-red-color'>inn</b></span>;
 	 <span id="object3"><b class='ct-blue-color'>Outer</b> <b class='ct-red-color'>out</b></span>;
    <span id="objVal3"><b class='ct-red-color'>inn</b>.age =  <span id="value3">36</span>;</span>
	 ...
	 <span id="cout5">cout << <b class='ct-red-color'>out</b>.id  << endl;</span>  
			...
			<div class="col-xs-4 margin-top-20">
				<div id="outputDiv" class="opacity00" >
					...
					<div id="outputBody" class="output-console-body" class="col-xs-offset-1 col-xs-5">
					</div>
				</div>
			</div>
		</div>
