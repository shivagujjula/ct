...
<script src="/secure/lang/cpp/js-min/bao.min.js"></script>
...
$(document).ready(function() {
	...
	<h2 class="text-center">
		<span class="label label-default ct-demo-heading">Bitwise AND operator</span>
	</h2>
			...
			<li class='opacity00' id='li2'>In <span class='ct-code-b-green'><b>C++</b></span> programming
				...
				<ul>
					<li>In this demo we will discuss about <b>bitwise</b> <span
						class='ct-code-b-green'>AND</span> operator.
					</li>
				</ul></li>
			<li class='opacity00' id='li3'><b>Bitwise</b> <span
				class='ct-code-b-green'>AND</span> operator is represented as: <span
				class='ct-code-b-green'>&</span> (a single ampersand).</li>
			<!-- <li class= 'opacity00' id='li4'><b>Bitwise</b> <span class='ct-code-b-green'>AND(&)</span> operator is performed on only binary data.</li> -->
			<li class='opacity00' id='li4'>When <b>bitwise</b> <span
				class='ct-code-b-green'>AND</span> operator is performed on two bits
				the resultant value is <span class='ct-code-b-green'>1</span> when
				both the bits are <span class='ct-code-b-green'>1</span>. In all
				other cases the resultant value is <span class='ct-code-b-green'>0</span>.
			</li>
		</ul>
		...
		<div id="tableDiv" class="col-xs-4" style="padding: 11px;">
			<table class="table-border text-center margin-top20 opacity00"
				...
				<tr id="row01">
					...
					<td class="table-border"><span id="2">0</span></td>
				</tr>
				<tr id="row10">
					<td class="table-border">1</td>
					<td class="table-border">0</td>
					<td class="table-border"><span id="3">0</span></td>
				</tr>
				<tr id="row11">
					<td class="table-border">1</td>
					<td class="table-border">1</td>
