...
<script src="/secure/lang/cpp/js-min/mri.min.js"></script>
...
<div class="col-xs-12 padding00">
	...
	<div class="col-xs-12 padding00">
		<div class="col-xs-12 opacity00" id="bodyContent">
...
int main() {
	...
	<span id="printf1">cout << "\nBefore interchange :\n";</span>
	<span id="forLoop2">for(row = 0; row < 3; row++) {
 		for(col = 0; col < 3; col++)
  			cout << "\t" << arr[row][col];
  		cout << "\n";
 	}</span> 
	<span id="printf2">cout << "Enter the numbers of two rows to be exchanged\n";</span>
	<span id="scanf2">cin >> row1 >> row2;</span>
	...
	<span id="printf3">cout << "The matix after interchanging the two rows in the original matrix\n";</span>
	<span id="forLoop4">for(row = 0; row < 3; row++) {
		for(col = 0; col < 3; col++) {
			cout << "\t" << arr[row][col];
		}</span>
		<span id="printf4">cout << "\n";</span>
	}
}</pre>
			</div>
			<div class="col-xs-6 padding00">
