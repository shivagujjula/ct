		...
		<div class="col-xs-8 col-xs-offset-2 margin-top-20 opacity00" id="informationDiv" style='border: 1px solid gray;'>
			<ul>
				...
				<li id="li2"  class="opacity00">The format of a <b>pure virtual function</b> 
				 	is : <b  class="ct-red-color">virtual</b> <b>return_type function_name()</b> = <b>0</b>;</li>
					 <button class="introjs-button user-button opacity00" id='nextButton'>Next&#8594;</button>
				<li id="li3" class="opacity00">If a class contains one or more <b>pure virtual function</b>
					 such a class is called an <b>abstract class</b>. Objects to that abstract
	    			 class cannot be created.</li><a class="introjs-button user-button opacity00" id='nextButton'>Next&#8594;</a>
				<li id="li4" class="opacity00">The derived class without pure virtual functions and implementing these functions is called as 
					<b>concrete class</b>.</li>
...
#include &lt;iostream&gt;
using namespace std;
<span id="base">class Company {
   public :	
	  <span id="virtual"><b class="ct-red-color">virtual</b> void displayName() = 0;</span>
	  <span id="virtual2"><b class="ct-red-color">virtual</b> void displayLocation() = 0;</span>
};</span>

<span id="derived">class Employee : public Company {
   public :
...
<span id="main">int main() {
	...
	<span style='white-space: nowrap;' id="obj2">Company *obj;</span>
	<span id="emp">Employee emp;</span>
	<span id="objaddr">obj = &amp;emp;</span>
	<span id="display">obj -&gt; displayName();</span>
	<span id="display2">obj -&gt; displayLoacation();</span>
	...
	<div class="col-xs-12">
		<div class="col-xs-8 col-xs-offset-2 box-border opacity00" id="animationBox">
			<div class="col-xs-12 margin-top-20" id="objpointer">
	        	<div class="col-xs-4" id="pointer" style="padding-right : 64px;  padding-left : 8px;  padding-top : 10px; margin-top : 20px;">
	        		<div id="s1" class="col-xs-4 col-xs-offset-4 opacity00"><b style="color : maroon; padding-left: 4px;">obj</b>
					</div>
	            	<div class="col-xs-6 col-xs-offset-3  opacity00 box-border1" id="box">
	              	 ...
	              	 <div>
	              	 	<b class="col-xs-4 col-xs-offset-3 opacity00" id="addr" style="color : maroon;">1024
	              	 	</b>
	              	 </div>
	             </div>
	             <div class="col-xs-8" id="pointer2" style="padding-left: 8px;padding-right: 8px;">
	        ...
	        <svg class='svg-css' id='svg'>
				...
				<line  class="svg-line" x1="33.4%" y1="46%" x2="33.5%" y2="46%"/>
			</svg> 
		</div>
	</div>
</div>
