...
<script src="/secure/lang/cpp/js-min/spofsc.min.js" type="text/javascript"></script>
...
<body>
	...
	<span id="mainFun">int <b class='ct-blue-color'>main()</b> {
		<span id="mainVar1">float x;</span>
		<span id="mainVar2">int n;</span>
		<span id="mainPrintf1">cout << "Enter number of terms : ";</span>
		<span id="ncin">cin >> <span id="dAddr">n</span>;</span>
		<span id="mainPrintf2">cout << "Enter number of degrees : ";</span>
		<span id="xcin">cin >> <span id="fAddr">x</span>;</span>
		<span id="xInDeg">x = (x * 3.14) / 180;</span>
		<span id="mainPrintf3">cout << "The sine value = " << <span id="sinCall" class='ct-green-color'>sine(<span id="ntransfer1">n</span>, <span id="xtransfer1">x</span>)</span> << endl;</span>
		<span id="mainPrintf4">cout << "The cosine value = " << <span id="cosCall" class='ct-green-color'>cosine(<span id="ntransfer2">n</span>, <span id="xtransfer2">x</span>)</span> << endl;</span>
		<span id="mainPrintf5">cout << "The tan value = " << <span id="tanCall" class='ct-green-color'>sine(n, x) / cosine(n, x)</span> << endl;</span>
