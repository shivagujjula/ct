...
<span id="main">main() {
		...
		<span id="sOut">cout << s;</span>
			...
			<div id="addressDiv" class="col-xs-6 address-box padding00 margin-top-2 col-xs-offset-1 opacity00">
			...
			<div class="col-xs-4 col-xs-offset-1 margin-top-25">
				<div id="consoleId" class="center opacity00" style="margin-top: 3%; ">
					...
					<div class="output-console-body" id="consoleBodyDiv">
						...
						<div id="enterStuName" class="opacity00" >Enter student name :   <input id="enterName"  class="input-char position opacity00" spellcheck="false" /></div>
						<div id="enterNo" class="opacity00">Enter no :  <input id="printLineInConsole1"  maxlength="5" class="input-char2 position opacity00" spellcheck="false"></input></div>
