	...
	introjs.onafterchange(function(targetElement) {
		...
		case "intDec":
			$('.introjs-helperLayer').one('transitionend', function() {
				$('.introjs-tooltip').removeClass('hide');
				var text = "A variable <y>i</y> of type <y>int</y> is declared";
				typing('.introjs-tooltiptext', text, function() {
		...
		case "tableId1":
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				if (introjs._direction == 'forward') {
					spaceFind();
					if (spaceFlag) {
						var text = "The <span class='ct-code-b-yellow'>cin</span> function reads all the characters that are specified"
						...
						var text = "Since you have provided a space only the first sequence of characters before the space is considered is"
							+ " read by the <span class='ct-code-b-yellow'>cin</span> method.";
					}
		...
		case "scanf":
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				$('.introjs-tooltip').removeClass('hide');
				var text = "The <span class='ct-code-b-yellow'>cin</span> reads multiple characters specified on the console until it encounters a white space.<br><br>"
		...
		case "condition":
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				var text1 = "The condition in the while loop evaluates if the character at the given position <y>i</y> is <y>\\0</y> or not.<br><br>"
				if (($('#usrText').val().charAt(count) == " ") || ($('#usrText').val().charAt(count) == "")) {
					...
					var text = 	 text1 + "<y>a[" + count + "] = \\0</y> and" 
					...
					introjs.insertOption(introjs._currentStep + 1, newStep);
					var text = text1 + "<y>a[" + count + "] = " + $('#usrText').val().charAt(count)
								+ "</y> and <span class='ct-code-b-yellow'>" +  $('#usrText').val().charAt(count) +" != \\0 </span> <br>condition"
		...
		case "increment":
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				var text = "Since the character at <br><span class='ct-code-b-yellow'>ch[" + count + "]</span> = "
							...
							+ "</span> <y>& "+ $("#usrText").val().charAt(count) + " != \\0</y> <br>then the <span class='ct-code-b-yellow'>i</span>"
		...
		case "stringLength":
			$('.introjs-helperLayer ').one('transitionend', function() {
				var text = "The <span class='ct-code-b-yellow'>cout</span> which uses format character prints all the characters stored in the character array"
