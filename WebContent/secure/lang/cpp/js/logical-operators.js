	...
	intro.onafterchange(function(targetElement) {
		...
		case "inputDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Enter <span class='ct-code-b-yellow'>integer</span> values in both the boxes."
		...
		case "animationDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "<span id='first'>Here, we can see different <span class='ct-code-b-yellow'>logical operators</span> with expressions.</span><ul><span id='amperson'></span></ul>";
				typing(".introjs-tooltiptext", text, function() {
					nextClick();
