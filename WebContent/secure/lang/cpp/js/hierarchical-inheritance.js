...
var inheritanceConceptReady = function() {
	...
	var text = "Here we will learn the <y>hierarchical inheritance</y>.";
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "print1":
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				introjs.insertOption(introjs._currentStep + 2, insertionIntro("cout1", "", "right", ""));
				
				var text = "Now the <y>obj1</y> can access the publically inherited <y>class A</y> member"
		...
		case "print2":
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Now the <y>obj2</y> can access the publically"
							+" inherited <y>class A</y> member function <y>display()</y>.";
		...
		case "showMthd4":
			$(".introjs-helperLayer").one("transitionend", function() {
					...
					if (introjs._direction == "forward") {
						introjs.insertOption(introjs._currentStep + 1, insertionIntro("cout3", "", "right", ""));
					}
					stepNext();
			})
		break;	
