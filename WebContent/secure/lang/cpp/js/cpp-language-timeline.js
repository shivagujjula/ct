var tooltipMap = {
	"#simulaGroup" :"<li>The first object oriented programming language is <span class='ct-code-b-green'><b>simula 67</b></span>.</li>" +
			...
			" and  <span class='ct-code-b-green'>garbage collections</span>.</li>",
	...
	"#simulaGroup2" :"<li><span class='ct-code-b-green'>Bjarne-Stroustrup</span> developed a " +
			"new programming language when he was doing work for his <span class='ct-code-b-green'>P.H.D</span> in 1979.</li>" +
			"<li>He named it as <span class='ct-code-b-green'>C with Classes</span>.</li>" +
			"<li>This language is derived from <span class='ct-code-b-green'>c-language</span> " +
			"and different <span class='ct-code-b-green'>oops concepts</span>.</li>" ,
...
function nextBtnAnimation(selector, nextAnimation) {
	$(selector).popover({
		trigger : "focus",
		position: "right",
		content: "<a class='btn next-btn' onclick='" + nextAnimation + "'>Next &rarr;</a>",
		html : true,
		container : "#totalDiv",
	});
  ...
  arrowReveal($(circleId).next(), function() {
    ...
    if (imgId.trim().length != "") {
      ...
      $(imgId).show().attr("class", "animated fadeIn").one("animationend", function() {
    	  ...
    	  if (id1 == "#simulaGroup") {
    		  customPopover($("#img1"), "right", tooltipMap[id1], callBackFunction);
    	  } else {
