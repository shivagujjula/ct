	...
	introjs.onafterchange(function(targetElement) {
		...
		case "swapDeclareLine":
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'This statement declares a <span class="ct-code-b-yellow">swap()</span> '+
									'method with two arguments of type <span class="ct-code-b-yellow">int</span>. ' +
									'The <span class="ct-code-b-yellow">int</span> is a keyword used when a method '+
									'returns a value.';
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
		...
		case "aLine":
			introjs.refresh();
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'A variable <span class="ct-code-b-yellow">a</span> of type ' +
									'<span class="ct-code-b-yellow">int</span> is initialized ' +
									'with value <span class="ct-code-b-yellow">' + $('#valueOfA').text() + '</span>.';
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
				});
			});
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				case "aBoxAnimate":
					...
					var typingContent = 'As <span class="ct-code-b-yellow">a</span> is of type <span class="ct-code-b-yellow">int</span>, ' +
										'it occupies <span class="ct-code-b-yellow">2 bytes</span> of memory with some address.<br>Let us assume ' +
		...
		case "bLine":
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'A variable <span class="ct-code-b-yellow">b</span> of type '+
									'<span class="ct-code-b-yellow">int</span> is initialized with '+ 
									'value <span class="ct-code-b-yellow">' + $('#valueOfB').text() + '</span>.';
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
				});
			});
					...
					if (introjs._direction == "backward") {
						...
						transferEffect1("#swapAftr", "#aftrSwap", function(){
							...
							typing("#aftrSwap", typingContent, 30, 'white', function() {
								$("#aBox").addClass("z-index9999999");
								transferEffect1("#ptrX", "#xAftr", function(){
									transferEffect("#ptrXVal", "#xConsVal", function(){
										$("#aBox").removeClass("z-index9999999");
										$("#bBox").addClass("z-index9999999");
										transferEffect1("#ptrY", "#yAftr", function(){
											transferEffect("#ptrYVal", "#yConsVal", function(){
												$("#bBox").removeClass("z-index9999999");
												setTimeout(function() {
													introjs.nextStep();
												},500);
		...
		case "swapMethodBlock":
			var typingContent = 'This is the <span class="ct-code-b-yellow">swap()</span> method. It takes two arguments of type ' +
								...
								$('#bAddress').text() + '</span> respectively.<br/>';
			typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
				$(".introjs-nextbutton, .introjs-prevbutton").show();
			});
			break;
