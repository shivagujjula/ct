...
function initIntroJS() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		switch(elementId) {
			...
			case "heading":
				var text = "Let us learn the steps involved in writing and executing"+
					" a <b class='ct-code-b-yellow'>C++</b> program.";
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						typing('#step1Text', text, function() {
							$("#sourceCode").fadeTo(1000, 1, function() {
								...
								$(".popover").css({"top" : "0px;"});
								var text = "We can use any text editor to write a "+
									"<b class='ct-code-b-yellow one'>C++</b> program.";
								typing("#popover1", text, function() {
									$('#popover1').append('<div class="popover-height">'+
											'<span class="introjs-button custom-btn" onclick="userButton(1)">Next &#8594;</span></div>');
								});
							});
						});
					});
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						typing('#step2Text', text, function() {
							...
							var text = "The file name in which the <b class='ct-code-b-yellow two'>C++</b> code is written should" 
										+ " end with <span class='ct-code-b-yellow two'>.cpp</span> extension.";
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						typing('#step3Text', text, function() {
							...
							var text = "Compilation has two main steps<br>1 - Object file creation and <br>2 - Linking<br>" 
										...
										+ "<span class='compilation-style'>g++ -o Hello.out Hello.cpp</span>"
