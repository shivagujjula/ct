...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case 'preTableDiv':
			$('.introjs-helperLayer').one('transitionend', function() {
				$("#preTableDiv").removeClass("opacity00", function() {
					typing('.introjs-tooltiptext', "Let us consider an example using <span class='ct-code-b-yellow'>put()</span> function.", function() {
		...
		case 'line3':
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing('.introjs-tooltiptext', "<span class='ct-code-b-yellow'>cout</span> is  used to display the message"+
						" specified with in double quotes on the output screen.", function() {
					$(".introjs-nextbutton").show();
				});
			});
			break;
		case 'line4':
			...
			$('.introjs-helperLayer').one('transitionend', function() {
				...
				var text = "<span class='ct-code-b-yellow'>get()</span> is instance of <span class='ct-code-b-yellow'>istream</span> class which reads only " +
		...
		case 'line5':
			$('.introjs-helperLayer ').one('transitionend', function() {
				var text = "The <span class='ct-code-b-yellow'>put()</span> is used to write the value stored in the character "+
		...
		case 'preDiv':
			$('.introjs-helperLayer').one("transitionend", function() {
				...
				var text = "Let us consider different examples using <span class='ct-code-b-yellow'>put()</span> function."
					typing(".introjs-tooltiptext", text, function() {
		...
		case 'line7':
			$('.introjs-helperLayer ').one('transitionend', function() {
				$("#line6").removeClass("visibility-hidden", function() {
					var text = "In this <span class='ct-code-b-yellow'>put()</span> function since an integer value is provided instead "+
		...
		case 'line8':
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				typing('.introjs-tooltiptext', "Any integer placed without quotes in <span class='ct-code-b-yellow'>put()</span> that will " +
		...
		case 'consoleId':
			...
			case 'secondStep':
				...
				$('.introjs-helperLayer ').one('transitionend', function() {
					...
					typing('.introjs-tooltiptext', "<span class='ct-code-b-yellow'>put()</span> displays the character on the console.", function() {
