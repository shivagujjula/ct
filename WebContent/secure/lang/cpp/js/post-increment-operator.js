		...
		switch (elementId) {
			case "program" :
				 ...
				 text = '<span class="ct-code-b-yellow">++</span> indicates increment.<br>'+
				 		...
				 		' it is called <span class="ct-code-b-yellow">post-increment</span>.<br/><br/>'+
				 		'Let us learn how a <span class="ct-code-b-yellow">post-increment</span> operator '+
				 		'works.'
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					case "example" :
						...
						text = 'Here, we are using a '+
								'<span class="ct-code-b-yellow">post-increment</span> operator.';
						typing('.introjs-tooltiptext', text, typingInterval, 'white', function() {
							$('.introjs-nextbutton, .introjs-prevbutton').show();
						});
					break;
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					$('.animation-div1').fadeTo(500, 1, function() {
						svgBoxAnimation(0, function() {
							$('.introjs-tooltip').removeClass('hide');
							text = 'In the above expression, we are using <span class="ct-code-b-yellow">post-increment</span>'+
						...
						$("#yCup").removeClass("visibility-hidden");
							setTimeout(function() {
								...
								$("#yVariableDeclararionLine").effect( "transfer", { to: $("#yvalueassignment"), className: "ui-effects-transfer" }, 1000 , function(){
									$('.animation-div5').fadeTo(1000, 1, function() {
			...
			case "outputDiv":
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					if (introcode._currentStep == 8) {
						$(".output").append('<span id="xVal"> x value : '+ $("#xCupValue").text() + '</span><br>');
						setTimeout(function(){
							introcode.nextStep();
						},1000);
						...
						$(".output").append('<br><span id="xVal1"> x value : '+ $("#xCupValue").text() + '</span>');
						setTimeout(function(){
							introcode.nextStep();
						},1000);
					}
			...
			case "singleStatement"  :
				...
				$('.introjs-helperLayer').one('transitionend', function() {
						$('.introjs-tooltip').removeClass('hide');
						text = '<span class="ct-code-b-yellow">post-increment</span> operator '+
			...
			case "animationDiv5"  :
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					$("#singleStatement").effect( "transfer", { to: $("#singleStatementDiv"), className: "ui-effects-transfer" }, 1000 , function(){
						$('.animation-div6').fadeTo(500, 1, function() {
							$('.introjs-tooltip').removeClass('hide');
							text = '<span class="ct-code-b-yellow">x</span> value '+
									...
									' <span class="ct-code-b-yellow">1</span>.<br/>'+
	...
	typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
		...
		$(".introjs-duplicate-nextbutton").click(function() {
			...
			fromEffectWithTweenMax('#xCupValue', '#yCupValue', function() {
				...
				$('.introjs-tooltip').removeClass('hide');
				text = 'Now the value <span class="ct-code-b-yellow">'+ $("#xvalue").text() +'</span>'+
						' contain in <span class="ct-code-b-yellow">x</span> is '+
				...
				$(".introjs-duplicate-nextbutton").click(function() {
					...
					$('.animation-div2').fadeTo(500, 1, function() {
						...
						text = 'First, the <span class="ct-code-b-yellow">x</span> value will be assigned to the '+
								'variable <span class="ct-code-b-yellow">y</span>.<br/><br/>'+
								'<span id="appendSpan1"></span>';
						typing('#appendSpan', text, typingInterval, 'white', function() {
...
function fromEffectWithTweenMax(selector1, selector2, callBackFunction) {
	...
	TweenMax.from($(selector2), 0.3, {top: topLength, left: leftLength, onComplete: function() {
