		...
		$('.introjs-helperLayer').one('transitionend', function() {
			switch (elementId) {
				...
				case "matrixRowInterChange" :
					$("#bodyContent").removeClass("opacity00");
				...
				case "arrDec" :
					...
					text = 'Here, we are declaring and initializing an integer array'
							...
							+ '<span class="ct-code-b-yellow">temp</span> value will be initialize to 0.';
					typing('.introjs-tooltiptext', text, function() {
				...
				case "outputDiv":
					...
					switch(animateStep) {
						case "readMatrixValues" :
							...
							typing(".introjs-tooltiptext", text, function() {
								tableIndex();
						 		$("#consoleBodyDiv1").append("<div>Enter the value of a00 : "
				...
				case "scanf" + count :
					$('.introjs-tooltip').removeClass('hide');
					text = 'The <span class="ct-code-b-yellow">cin</span> reads'
