...
intro.onafterchange(function(targetElement) {
	...
	case "cout5":	
		...
		$(".introjs-nextbutton").hide();
		$(".introjs-helperLayer").one("transitionend", function() {
			var text = "The <span class='ct-code-b-yellow'>cout</span> function will print the text which it is contains.";
				typing(".introjs-tooltiptext", text, function() {
					if (ElementId == "cout3") {
	...
	case "cin2":	
		$(".introjs-nextbutton").hide();
		$(".introjs-helperLayer").one("transitionend", function() {
			var text = "<span class='ct-code-b-yellow'>cin</span> function reads the value.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				})
		});
...
function loopSteps(i, matrix, name, val) {
	for(var j = 0; j < parseInt($("#cols" + matrix).text()); j++) {
		...
		$("#output").append("<span class='opacity00 removeId' id='nameSpan"+i+''+j+"'>Enter the elements for the matrix  "+ name + "" + i + "" + j + ":"
...
'     <span id="cout1">cout << "Enter the elements for matrix a" << i << j << " : " ;</span>\n'+
'     <span id="cin1">cin >> a[i][j];</span>\n'+
'    <span>}</span>\n'+
'  <span>}</span></span>\n'+
...
'    <span id="cout2">cout << "Enter the elements for matrix b" << i << j << " : " ;</span>\n'+
'     <span id="cin2">cin >> a[i][j];</span>\n'+
'   <span>}</span>\n'+
'  <span>}</span></span>\n'+
'  <span id="cout3">cout << "The matrix a[][] is :  ";</span>\n'+
...
'   }\n'+
' }</span>\n'+
' <span id="cout5">cout << "After matrix multiplication is : &#92;n";</span>\n'+
'  <span id="finalMatrix"><span>for ( <span>i = 0</span>; <span>i &lt; 2</span>; <span>i++</span>)</span> {\n'+
'   <span>for (j = 0; j &lt; 2; j++)</span> {\n'+
'    <span>cout <<  c[<span>i</span>][<span>j</span>] << " &#92;t";</span>\n'+
'   }\n'+
'   <span>cout << "&#92;n";</span>\n'+
'  }</span>\n'+
'}\n'+ 
