	...
	introjs.onafterchange(function(targetElement) {
		...
		case 'consoleId':
			...
			case 'printLineInConsole3':
				$('.introjs-helperLayer ').one('transitionend', function() {
					$("#printLineInConsole3").append($("#enterName").val());
			...
			case 'printLineInConsole4':
				$('.introjs-helperLayer ').one('transitionend', function() {
					$("#printLineInConsole4").append($("#printLineInConsole1").val());
						transferEffect("#sNo1", "#printLineInConsole4", function() {
							$('#printLineInConsole4').removeClass('opacity00');
								$('.introjs-nextbutton').show();
						});
				});
				break;
			...
			case 'printLineInConsole5':
				$('.introjs-helperLayer ').one('transitionend', function() {
					$("#printLineInConsole5").append($("#printLineInConsole2").val());
					transferEffect("#sMarks1", "#printLineInConsole5", function() {	
						$('#printLineInConsole5').removeClass('opacity00');
							$('.introjs-nextbutton').show();
					});
				});
				break;
