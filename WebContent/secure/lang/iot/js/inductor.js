	...
	intro.onafterchange(function(targetElement) { 
		...
		case "capacitorTitle" :
			...
			$('.introjs-nextbutton').hide();
		  	typing('.introjs-tooltiptext', "Let us learn about an Inductor.", function() {  
		...
		case "image" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#image").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "The figure shows the symbol of an Inductor.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "seriesConnectionTitle" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#seriesConnectionTitle").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "Let us learn about the series connection of an Inductor.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "seriesImage" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#seriesImage").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "A diagram of several Inductors, connected end to end in series, with the same amount of current passing through each.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "serieslFormula" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#serieslFormula").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "The total inductance of Inductors connected in series is the sum of their individual inductance values.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "exampleQuestion" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#exampleQuestion").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "Calculate the total inductance value in series.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "calculationDiv1" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#calculationDiv1").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "Please change any of the inductance values.", function() {
		...
		case "capacitorParallelTitle" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#capacitorParallelTitle").fadeTo(300, 1, function() {
			  		typing('.introjs-tooltiptext', "Let us learn about parallel inductance of an Inductor.", function() {  
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "parallelImage" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#parallelImage").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "A diagram of several Inductors, connected side by side parallely, i.e. in parallel connection.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "parallelFormula" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#parallelFormula").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "The total inductance of Inductors connected in parallel connection is the reciprocal of the sum of the reciprocals of the individual Inductors.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
		...
		case "exampleQuestion1" : 
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#exampleQuestion1").fadeTo(300, 1, function() {
					typing('.introjs-tooltiptext', "Calculate the total inductance value in parallel connection.", function() {
						$('.introjs-nextbutton').show();
						});
					});
				});
