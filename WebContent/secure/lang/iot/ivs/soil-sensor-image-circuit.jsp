...
<script src='/secure/lang/iot/js-min/ssic.min.js'></script>
...
<title>Soil sensor circuit</title>
<style type="text/css">
...
<div class="col-xs-12">
	...
	<div class="col-xs-6 col-xs-offset-3 margin-top-50 main-div text-center" id="mainDiv">
		<span id="imageIdSpan">
			<img src="../images/soilSensor-images/SoilSensor1_bb.jpg" width="70%" id="soilSensorVccPinImage">
		</span>
	</div>
