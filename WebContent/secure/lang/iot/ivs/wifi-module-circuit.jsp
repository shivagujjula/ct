...
<script src='/secure/lang/iot/js-min/wmc.min.js'></script>
...
<title>Wifi module circuit</title>
<style type="text/css">
...
<div class="col-xs-12">
	...
	<div class="col-xs-6 col-xs-offset-3 margin-top-50 main-div text-center" id="mainDiv">
		<span id="imageIdSpan">
			<img src="../images/NEWESP8266/1_ESP8266_bb.jpg" width="70%" id="vccPinImage">
		</span>
	</div>
